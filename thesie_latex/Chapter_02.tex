...
\begin{mydef}
Let $bitLength\in \left\{ {0,1,2,..., 32}\right\}$ and let $P$ be a function with one input and one output. Also input $S \in \left\{ {0,1,2,..., 1\ll 2^bitLength-1}\right\}$ and output $O \in \left\{ {0,1,2,..., 1\ll 2^bitLength-1}\right\}$.
\end{mydef}
